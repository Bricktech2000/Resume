...
- Designed a multilayer perceptron model atop the library and implemented stochastic gradient descent with momentum,  ultimately achieving **97% accuracy** on the MNIST database after 3 minutes training on 16 threads. 
